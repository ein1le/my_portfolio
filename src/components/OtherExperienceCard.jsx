  ...
  function LinkButton({ type, label_name, link, asset }) {
    ...
    const content = (
      <button
        ...
        onClick={type === "certificate" && asset ? handleCertificateClick : link ? (e) => { e.stopPropagation(); window.open(link, "_blank"); } : undefined}
        type="button"
      >
        {style.icon ? React.cloneElement(style.icon, { style: { ...style.icon.props.style, fontSize: 15, marginRight: 7 } }) : null}
